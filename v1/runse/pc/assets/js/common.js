...
function navBox() {
	...
	if ($(window).width() > 1360) {
		if ($(".asRegardS")[0]) {
			...
			$("#Hovering-arrows").css("right", "");
			$("#Hovering-arrows").css("left", $("#content").offset().left + 1200 + 40);
		} else {
			$("#Hovering-arrows").css("right", 20);
		}
	} else {
		$("#Hovering-arrows").css("left", "");
		$("#Hovering-arrows").css("right", 20);
	}
	$("#Hovering-arrows").css("display", "block");
}
