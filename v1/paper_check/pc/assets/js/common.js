var systemInfo = {
    ...
    crosscheck: {
        name: 'crosscheck查重',
        comparisonLibrary: '一个基于全球学术出版物所组成的庞大数据库和一个基于网页的检验工具',
        detectionAlgorithm: 'CrossCheck是国际上著名的多语种论文抄袭检测软件，国际期刊投稿前必备的检测系统。提前检测可避免重复率过高被拒稿的风险，已经为业界无数的出版商、编辑、研究人员以及作者提供了良好的检测服务',
        Language: '中文、英文',
        detectionScope: '专科、本科论文',
        timeConsuming: '10-30分钟',
        reportSample: '',
