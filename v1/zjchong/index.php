...
$route = [
    ...
    '/demo_aigc_compare.html'=>[
        'pc'=>__DIR__ . '/pc/demo_aigc_compare.html',
        'mobile'=>__DIR__ . '/pc/demo_aigc_compare.html'
    ],
    '/demo_cc_compare.html'=>[
        'pc'=>__DIR__ . '/pc/demo_cc_compare.html',
        'mobile'=>__DIR__ . '/pc/demo_cc_compare.html'
    ],
    '/pay_result.html'=>[
