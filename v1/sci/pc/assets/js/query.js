...
function tableHtml(params) {
    ...
    for (var i = 0; i < params.length; i++) {
        ...
        text += "   </td>";
        text += "	<td style=\"text-align:center;\">" + params[i].name + "</td>";
        text += "	<td style=\"text-align:center;\">" + (params[i].place_order_data && params[i].place_order_data.magazine && params[i].place_order_data.magazine.value? params[i].place_order_data.magazine.value : '未知') +  "</td>";
