function ResultHtml(src) {
    ...
    for(var i=0; i<src.length; i++) {
        ...
        if(src[i].label == 'zengsong') {
                text += "                   <img class=\"Label\" src=\"/html/v1/ai_paper_report/mobile/assets/img/Present.png\" alt=\"\">";
        }else if(src[i].label == 'zengzhi') {
            text += "                   <img class=\"Label\" src=\"/html/v1/ai_paper_report/mobile/assets/img/Value-added.png\" alt=\"\">";
        }
        text += "                </span>"
        text += "            </div>";
        text += "            <i></i>";
